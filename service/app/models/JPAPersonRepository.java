...
public class JPAPersonRepository implements PersonRepository {
    ...
    @Override
    public CompletionStage<Person> delete(String name) {
        return supplyAsync(() -> wrap(em -> del(em, name)), executionContext);
    }
    ...
    private Person del(EntityManager em,String name) {
        Person foundPerson = em.createQuery("select p from Person p where p.name=:name",Person.class).setParameter("name", name).getSingleResult();
