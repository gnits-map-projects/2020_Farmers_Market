                ...
                <div key={item.id} className = "cropList">
                    <Row>
                        ...
                        <Col xs="3">
                            ...
                            {item.status=="payed" && <button type="submit" id={item.id} className="btn btn-info btn-lg" onClick={() => {window.location.href = "/deliverCrop/" + item.id +'/'+ item.fid}}>DELIVER CROP</button>}
                        </Col>
                    </Row><hr/>
                </div>
            )
